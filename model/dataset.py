...
class BatchLoader(object):
    def __init__(self, data_dir, split, tokenizer, toks_in_batch, device="cpu"):
        ...
        with open(f"{data_dir}/{split}.json", 'r', encoding='utf-8') as json_file:
            raw_data = json.load(json_file)

        # my data contains attributes : A, B, C ...
